...
export function Home() {
  return (
    <div className="w-full bg-white relative overflow-hidden font-sans">
      ...
      {/* New Hero Section */}
      <section 
        className="relative pt-32 pb-20 md:pt-40 md:pb-24 px-6 min-h-screen flex items-center z-10 bg-cover bg-center bg-no-repeat transition-all duration-500 overflow-hidden"
        style={{ backgroundImage: `url(${heroBannerImg})` }}
      >
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="w-full lg:w-[50%] xl:w-[45%] text-left mt-10 md:mt-0">
            <motion.h1
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              className="text-6xl md:text-7xl lg:text-8xl font-serif text-black leading-[1.1] mb-6 flex flex-col"
            >
            ...
            <motion.p
              ...
              className="text-black/80 text-lg md:text-xl md:leading-relaxed mb-10 max-w-lg font-medium"
            >
            ...
            >
              <button className="bg-gradient-to-r from-[#2186b5] to-[#4abbe1] hover:scale-105 transition-transform text-white px-10 py-4 rounded-full font-semibold shadow-2xl shadow-[#2186b5]/40 text-lg">
                Explore
              </button>
              
              <div className="bg-white/40 backdrop-blur-md border border-white/60 text-black px-6 py-3 rounded-2xl flex flex-col items-center justify-center shadow-lg">
